...
| Current commercial evidence | Owner attestation plus owner-retained credit-note screenshot, SHA-256 recorded in [owner-confirmations.md](owner-confirmations.md); associated invoice, coverage history, generation-history export, and dated terms remain outstanding |
